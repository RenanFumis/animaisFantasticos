...
/***/ "./js/module/HorarioFuncionamento_dateObject.js":
/*!******************************************************!*\
  !*** ./js/module/HorarioFuncionamento_dateObject.js ***!
  \******************************************************/
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ dropDownMenuIniciar)\n/* harmony export */ });\n/* harmony import */ var _clicandoForaMenuDropdown_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./clicandoForaMenuDropdown.js */ \"./js/module/clicandoForaMenuDropdown.js\");\n\nfunction dropDownMenuIniciar() {\n  var menusDropdown = document.querySelectorAll('[data-dropdown]');\n  menusDropdown.forEach(function (menu) {\n    ['touchstart', 'click'].forEach(function (eventUser) {\n      menu.addEventListener(eventUser, handleClick, {\n        passive: true\n      });\n    });\n  });\n  function handleClick(e) {\n    var _this = this;\n    e.preventDefault();\n    this.classList.add('ativo');\n    (0,_clicandoForaMenuDropdown_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, ['click', 'touchstart'], function () {\n      _this.classList.remove('ativo');\n    });\n  }\n}\n\n//# sourceURL=webpack://animais_fantasticos/./js/module/dropDownMenuIniciar.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ apiBitcoin)\n/* harmony export */ });\nfunction apiBitcoin() {\n  fetch('https://blockchain.info/ticker').then(function (response) {\n    return response.json();\n  }).then(function (json) {\n    var bitcoinPreco = (100 / json.BRL.sell).toFixed(5);\n    var liBitcoin = document.querySelector('.btcPreco');\n    liBitcoin.innerText = bitcoinPreco;\n  })[\"catch\"](function (erro) {\n    console.log(Error(erro));\n  });\n}\n\n//# sourceURL=webpack://animais_fantasticos/./js/module/fetchBitcoin.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ menuMobileIniciar)\n/* harmony export */ });\n/* harmony import */ var _clicandoForaMenuDropdown_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./clicandoForaMenuDropdown.js */ \"./js/module/clicandoForaMenuDropdown.js\");\n //Quando importar algo que está na mesma pasta é só começar com ./\n\nfunction menuMobileIniciar() {\n  var menuBotao = document.querySelector('[data-menu=\"button\"]');\n  var menuLista = document.querySelector('[data-menu=\"lista\"]');\n  var eventos = ['click', 'touchstart'];\n  if (menuBotao) {\n    var abrirMenu = function abrirMenu() {\n      menuLista.classList.add('ativo');\n      menuBotao.classList.add('ativo');\n      (0,_clicandoForaMenuDropdown_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(menuLista, eventos, function () {\n        menuLista.classList.remove('ativo');\n        menuBotao.classList.remove('ativo');\n      });\n    };\n    eventos.forEach(function (e) {\n      menuBotao.addEventListener(e, abrirMenu, {\n        passive: true\n      });\n    });\n    menuBotao.addEventListener('click', abrirMenu);\n  }\n}\n\n//# sourceURL=webpack://animais_fantasticos/./js/module/menuMobile.js?");
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony export */ __webpack_require__.d(__webpack_exports__, {\n/* harmony export */   \"default\": () => (/* binding */ TabFaq)\n/* harmony export */ });\n/* harmony import */ var _babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! @babel/runtime/helpers/classCallCheck */ \"./node_modules/@babel/runtime/helpers/esm/classCallCheck.js\");\n/* harmony import */ var _babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! @babel/runtime/helpers/createClass */ \"./node_modules/@babel/runtime/helpers/esm/createClass.js\");\n\n\nvar TabFaq = /*#__PURE__*/function () {\n  function TabFaq(list) {\n    (0,_babel_runtime_helpers_classCallCheck__WEBPACK_IMPORTED_MODULE_0__[\"default\"])(this, TabFaq);\n    this.accordionList = document.querySelectorAll(list);\n    this.activeClass = 'ativo';\n  }\n  (0,_babel_runtime_helpers_createClass__WEBPACK_IMPORTED_MODULE_1__[\"default\"])(TabFaq, [{\n    key: \"toggleAccordion\",\n    value: function toggleAccordion(item) {\n      item.classList.toggle(this.activeClass);\n      item.nextElementSibling.classList.toggle(this.activeClass);\n    }\n\n    // Adicionando os eventos no accordion\n  }, {\n    key: \"addAccordionEvent\",\n    value: function addAccordionEvent() {\n      var _this = this;\n      this.accordionList.forEach(function (item) {\n        item.addEventListener('click', function () {\n          return _this.toggleAccordion(item);\n        });\n      });\n    }\n    // Iniciando Função\n  }, {\n    key: \"init\",\n    value: function init() {\n      if (this.accordionList.length) {\n        // Ativando primeiro item\n        this.toggleAccordion(this.accordionList[0]);\n        this.addAccordionEvent();\n      }\n      return this;\n    }\n  }]);\n  return TabFaq;\n}();\n\n\n//# sourceURL=webpack://animais_fantasticos/./js/module/tabFaqIniciar.js?");

/***/ }),

/***/ "./js/module/tabNavegacaoIniciar.js":
/*!******************************************!*\
  !*** ./js/module/tabNavegacaoIniciar.js ***!
  \******************************************/
/***/ ((__unused_webpack_module, __webpack_exports__, __webpack_require__) => {
...
"use strict";
eval("__webpack_require__.r(__webpack_exports__);\n/* harmony import */ var _module_scroll_suave_js__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(/*! ./module/scroll-suave.js */ \"./js/module/scroll-suave.js\");\n/* harmony import */ var _module_scroll_animacao_js__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./module/scroll-animacao.js */ \"./js/module/scroll-animacao.js\");\n/* harmony import */ var _module_tabFaqIniciar_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./module/tabFaqIniciar.js */ \"./js/module/tabFaqIniciar.js\");\n/* harmony import */ var _module_tabNavegacaoIniciar_js__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./module/tabNavegacaoIniciar.js */ \"./js/module/tabNavegacaoIniciar.js\");\n/* harmony import */ var _module_modal_js__WEBPACK_IMPORTED_MODULE_4__ = __webpack_require__(/*! ./module/modal.js */ \"./js/module/modal.js\");\n/* harmony import */ var _module_tooltip_js__WEBPACK_IMPORTED_MODULE_5__ = __webpack_require__(/*! ./module/tooltip.js */ \"./js/module/tooltip.js\");\n/* harmony import */ var _module_dropDownMenuIniciar_js__WEBPACK_IMPORTED_MODULE_6__ = __webpack_require__(/*! ./module/dropDownMenuIniciar.js */ \"./js/module/dropDownMenuIniciar.js\");\n/* harmony import */ var _module_menuMobile_js__WEBPACK_IMPORTED_MODULE_7__ = __webpack_require__(/*! ./module/menuMobile.js */ \"./js/module/menuMobile.js\");\n/* harmony import */ var _module_HorarioFuncionamento_dateObject_js__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ./module/HorarioFuncionamento_dateObject.js */ \"./js/module/HorarioFuncionamento_dateObject.js\");\n/* harmony import */ var _module_fetchAnimais_js__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ./module/fetchAnimais.js */ \"./js/module/fetchAnimais.js\");\n/* harmony import */ var _module_fetchBitcoin_js__WEBPACK_IMPORTED_MODULE_10__ = __webpack_require__(/*! ./module/fetchBitcoin.js */ \"./js/module/fetchBitcoin.js\");\n\nvar scrollsuave = new _module_scroll_suave_js__WEBPACK_IMPORTED_MODULE_0__[\"default\"]('[data-menu=\"suave\"] a[href^=\"#\"]');\nscrollsuave.init();\n\n(0,_module_scroll_animacao_js__WEBPACK_IMPORTED_MODULE_1__[\"default\"])();\n\nvar iniciarAccordion = new _module_tabFaqIniciar_js__WEBPACK_IMPORTED_MODULE_2__[\"default\"]('[data-pergunta=\"accordion\"] dt');\niniciarAccordion.init();\n\nvar tabNav = new _module_tabNavegacaoIniciar_js__WEBPACK_IMPORTED_MODULE_3__[\"default\"]('[data-tab=\"menu\"] li', '[data-tab=\"conteudo\"] section');\ntabNav.init();\n\nvar modal = new _module_modal_js__WEBPACK_IMPORTED_MODULE_4__[\"default\"]('[data-modal=\"abrir\"]', '[data-modal=\"fechar\"]', '[data-modal=\"container\"]');\nmodal.init();\n\nvar tooltip = new _module_tooltip_js__WEBPACK_IMPORTED_MODULE_5__[\"default\"]('[data-tooltip]');\ntooltip.init();\n\n(0,_module_dropDownMenuIniciar_js__WEBPACK_IMPORTED_MODULE_6__[\"default\"])();\n\n(0,_module_menuMobile_js__WEBPACK_IMPORTED_MODULE_7__[\"default\"])();\n\n(0,_module_HorarioFuncionamento_dateObject_js__WEBPACK_IMPORTED_MODULE_8__[\"default\"])();\n\n(0,_module_fetchAnimais_js__WEBPACK_IMPORTED_MODULE_9__[\"default\"])();\n\n(0,_module_fetchBitcoin_js__WEBPACK_IMPORTED_MODULE_10__[\"default\"])();\n\n//# sourceURL=webpack://animais_fantasticos/./js/script.js?");
